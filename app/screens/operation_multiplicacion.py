...
class Operation_Multiplicacion_Screen(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        self.title = Label(text="Multiplicacion", size_hint=(1, 0.1), font_size='20sp', color=(1, 0, 1, 1))
    ...
    def _crear_matriz(self, nombre):
        ...
        if nombre == 'B':
            ...
            self._decorar_fondo(self.box2, Color(0.3, 0.9, 0.3, 1), f'rect{nombre}')
            ...
            self._decorar_fondo(self.box, Color(0.3, 0.9, 0.3, 1), f'rect{nombre}')
    ...
    def ejecutar_operacion(self):
        ...
        try:
            if self.operacion_actual == 'multiplicacion':
